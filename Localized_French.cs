...
public class Localized_French : LOCALIZATION
{
    ...
    public override string ExpeditionMilestoneString(int id)
    {
        switch (id)
        {
            ...
            case 2: return "Débloque une Nouvelle Expédition Distante";
            case 3: return "Débloque une Équipe d'Expédition";
            case 4: return "Palier d'Expédition Nv 20";
            case 5: return "Débloque une Nouvelle Expédition Distante";
            case 6: return "Débloque une Équipe d'Expédition";
            case 7: return "Palier d'Expédition Nv 50";
            case 8: return "Débloque une Nouvelle Expédition Distante";
            case 9: return "Palier d'Expédition Nv 75";
            case 10: return "Débloque une Nouvelle Expédition Distante";
        }
        return "";
    }
    ...
    public override string HelpString(HelpKind kind)
    {
        ...
        switch (kind)
        {
            ...
            case HelpKind.Guild:
                ...
                tempStr += "\n- You can hover over the Passive/Active/Inactive button to determine your Background Efficiency %. This can be upgraded by completing a Proof of Rebirth 1/2/3/4/5/6 title quest, which you can get after reaching Hero Level 100.";
            ...
            case HelpKind.Bestiary:
                ...
                tempStr += "\n\n";
                tempStr += "Pet stats can be increased by leveling the pet and also from the hero multiplier stats from any source, this would include; Buff skills, skill passives for that hero, equipment effects, equipment enchants, potions, and blessings. As example : Having HP % gain will increase the HP Stat for the summoned pet for that hero with HP % Gain.";
                break;
            case HelpKind.Shop:
            ...
            case HelpKind.Rebirth:
                tempStr += "Rebirthing is like a mini reset just for your current active hero. You’ll then be able to increase their power through upgrades. Each tier of Rebirth will reset different things, and upgrades will be available for roughly what is being reset.";
                tempStr += "\n\n";
                tempStr += "<u>Tier 1</u>";
                tempStr += "\n- You must be at least level 100 on your active hero to be eligible for Rebirth Tier 1. Make sure to read in the Rebirth Tab what this will reset, and what the upgrades are.";
                tempStr += "\n- You gain Rebirth Points based on your Hero Level at the time of Rebirth, from completing different General Quests, and from your walked distance since the last rebirth.";
                tempStr += "\n- Bonuses : You gain extra Ability Points based on your max hero level reached for Tier 1, up to Hero Level 200 -100. So if you were to rebirth at Level 150, you would gain 50 extra Ability points upon rebirthing.";
                tempStr += "\n\n";
                tempStr += "<u>Tier 2</u>";
                tempStr += "\n- You must be at least level 200 on your active hero to be eligible for Rebirth Tier 2. You also must have the appropriate Rank of your town building [Temple] unlocked to perform a Rebirth Tier 2. ";
                tempStr += "\n- You gain Rebirth Points based on your Hero Skill levels, Hero Level starting at level 200, from completing different General Quests, and from your walked distance since the last rebirth.";
                tempStr += "\n- Bonuses : You gain extra ability points based on your max hero level reached for Tier 2, up to Level 300 -200 every 25th level. If you were to rebirth at Level 250, you would gain 50AP at level 25, level 50, level 75, so on. You also increase the Rebirth Tier 1 Bonus (extra AP) by a certain %. The math is +10 x [Tier 2 Rebirth#]^(2/3) %";
                tempStr += "\n\n";
                tempStr += "<u>Tier 3</u>";
                tempStr += "\n- You must be at least level 300 on your active hero to be eligible for Rebirth Tier 3. You also must have the appropriate Rank of your town building [Temple] unlocked to perform a Rebirth Tier 3. ";
                tempStr += "\n- You gain Rebirth Points based on your Hero Equipment levels, Hero Skill levels starting at level 100, Hero Level starting at level 300, from completing different General Quests, and from your walked distance since the last rebirth.";
                tempStr += "\n- Bonuses : You gain extra Basic Attack Skill levels based on your max hero level reached for Tier 3, up to Level 500 -300.  If you were to rebirth at Level 350, you would gain Lv 50 Basic Attack skill for that hero. You also increase the Rebirth Tier 2 Bonus (Extra AP every 25th level, and Tier 1 AP) by a certain %. The math is +10 x [Tier 3 Rebirth#]^(2/3) %";
                tempStr += "\n\n";
                break;
